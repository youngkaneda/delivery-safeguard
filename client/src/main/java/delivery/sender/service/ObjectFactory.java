 ...
 * generated in the delivery.sender.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _PostResponse_QNAME = new QName("http://service.sender.delivery/", "postResponse");
    private final static QName _Post_QNAME = new QName("http://service.sender.delivery/", "post");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: delivery.sender.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.sender.delivery/", name = "postResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.sender.delivery/", name = "post")
